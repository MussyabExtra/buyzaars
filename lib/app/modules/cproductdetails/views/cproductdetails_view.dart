...
import 'package:buyzaars/app/modules/cproductdetails/controllers/cproductdetails_controller.dart';
...
class CproductdetailsView extends GetView<CproductdetailsController> {
  const CproductdetailsView({super.key});
